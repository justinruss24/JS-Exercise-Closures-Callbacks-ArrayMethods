...
function processSum(numberList, callback) {
  /* CODE HERE */
  return callback(numberList.reduce((accum, value) => accum + value, 0));
}
...
function getFullNames(runners) {
  /* CODE HERE */
  let namesArray = [];
  runners.forEach(function(pers){
    return namesArray.push(`${pers.last_name}, ${pers.first_name}`);
  });
  return namesArray;
}
...
function firstNamesAllCaps(runners) {
  /* CODE HERE */
  return runners.map(function(pers){
    return pers.first_name.toUpperCase();
  });
}
...
function getRunnersByTShirtSize(runners, tShirtSize) {
  /* CODE HERE */
  return runners.filter(function(pers){
    return pers.shirt_size === tShirtSize;
  });
}
...
function tallyUpDonations(runners) {
  /* CODE HERE */
  return runners.reduce(function(accum, value){
